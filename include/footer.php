	...
	<div class="container-fluid sections-nobg">
      <div id="footer" class="container links-sec">
        <div class="row">
          <div class="col-md-12">
            <p class="text-uppercase"><a href="index.php">Home</a>|<a href="rooms.php">Cottage</a>|<a href="gallery.php">Gallery</a>|<a href="package.php">Packages</a>|<a href="contact.php">Contact</a>|<a href="https://g.page/the-wild-trails-resort-Munnar?share">Locate Us</a>|<a href="about.php">About</a>|<a href="terms.php">Terms and Conditions</a>|<a href="privacy.php">Privacy Policy</a>|<a href="refund.php">Refund Policy</a></p>
          </div>
          <div class="col-md-12">
